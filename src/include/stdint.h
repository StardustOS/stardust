 ...
 * Notes:
 * 
 * Some parts were obtained from the standard libraries like dietlibc but 
 * unnecessary code such as unused defines and macros need to be removed 
 * from here.
 */
...
#include <os/types.h> // This is used for int8_t
