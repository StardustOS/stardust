 ...
 * Notes:
 * 
 * Code here was initially obtained from dietlibc to permit the Java 
 * interpreter to be ported, but cleaning ie is required in order to 
 * remove unnecessary parts which are no longer used in the kernel.
 */
